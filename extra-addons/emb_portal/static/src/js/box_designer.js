...
odoo.define('emb_portal.box_designer', function (require) {
    'use strict';
    ...
    var DesignBox = Widget.extend({
        template: 'emb_portal.box_layout',
        ...
        _loadTemplates: function () {
            return ajax.loadXML('/emb_portal/static/src/xml/design_box.xml', qweb);
        },
    });
